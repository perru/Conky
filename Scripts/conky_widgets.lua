...
--	ring('time', '%S', 60, 0x000000, 0.2, 0x000000, 0.8, 200, 55, 50, 5, 0, 360)
--	clock_hands(463, 55, 0x000000, 0.8, false, 85)
--	ring('battery_percent', 'BAT1', 100, 0x000000, 0.2, 0x000000, 0.8, 573, 55, 50, 5, 0, 360)
	ring('cpu', 'cpu0', 100, 0x000000, 0.2, 0x000000, 0.8, 290, 100, 50, 5, 0, 360)
	ring('cpu', 'cpu1', 100, 0x000000, 0.2, 0x000000, 0.8, 455, 100, 50, 5, 0, 360)
	ring('memperc', '', 100, 0x000000, 0.2, 0x000000, 0.8, 620, 100, 50, 5, 0, 380)
